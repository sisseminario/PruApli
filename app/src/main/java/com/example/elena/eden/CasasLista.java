...
public class CasasLista extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_casas_lista);
        ...
        /*Intent maps = new Intent(this,MapsListActivity.class);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter implements OnLoadDataComplete {
        ...
        private Maspslist_Fragment masp;
